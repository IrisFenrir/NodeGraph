...
## 注意
1. 使用前请将png文件放入Resources文件夹，以确保节点正常显示。您也可以在GraphGlobalSetting.cs文件中更改文件的加载路径。
2. 使用前请将Bezier.cs和TypeUtility.cs放入到项目中，这是实现贝塞尔曲线和类型转换的工具类。
3. 如果您有兴趣，可以研究节点编辑器的框架部分代码。
4. 已基于本框架实现了行为树的节点编辑，可以在Example文件夹中查看。
